...
public class GlaiveItem extends SwordItem implements SeparatePerspective {

	private Identifier heldModel;

	public GlaiveItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, String heldModel) {
